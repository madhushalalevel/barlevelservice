  ...
  describe('Shelf Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ShelfComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.shelves && comp.shelves[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
