...
@NgModule({
  imports: [
    ...
    BarLevelServiceSharedModule.forRoot(),
    BarLevelServiceCoreModule,
    BarLevelServiceHomeModule,
    BarLevelServiceAccountModule,
