...
export class ProductImageComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.productImageService
      ...
      .subscribe(
        (res: HttpResponse<IProductImage[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInProductImages(): void {
    this.eventSubscriber = this.eventManager.subscribe('productImageListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProductImage[] | null, headers: HttpHeaders, page: number): void {
