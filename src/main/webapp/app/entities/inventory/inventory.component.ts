...
export class InventoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.inventoryService
      ...
      .subscribe(
        (res: HttpResponse<IInventory[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IInventory[] | null, headers: HttpHeaders, page: number): void {
