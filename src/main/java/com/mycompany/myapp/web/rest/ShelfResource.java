...
public class ShelfResource {
     ...
     */
    @GetMapping("/shelves")
    public ResponseEntity<List<ShelfDTO>> getAllShelves(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
