...
public class BranchResource {
     ...
     */
    @GetMapping("/branches")
    public ResponseEntity<List<BranchDTO>> getAllBranches(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
