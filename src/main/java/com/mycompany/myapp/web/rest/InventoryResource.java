...
public class InventoryResource {
    ...
    public ResponseEntity<List<InventoryDTO>> getAllInventories(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
