...
public class InventoryStockResource {
    ...
    public ResponseEntity<List<InventoryStockDTO>> getAllInventoryStocks(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
