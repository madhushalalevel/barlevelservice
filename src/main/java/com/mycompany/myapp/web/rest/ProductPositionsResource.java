...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.ProductPositions}.
 */
@RestController
@RequestMapping("/api")
public class ProductPositionsResource {
    ...
    public ResponseEntity<List<ProductPositionsDTO>> getAllProductPositions(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
